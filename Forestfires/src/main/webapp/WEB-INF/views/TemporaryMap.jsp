...
<%
    ...
    List<TemporaryDTO> mList = (List<TemporaryDTO>) session.getAttribute("tList");
...
<head>
    ...
    <script type="text/javascript">
        if("<%=locateYn.equals("")%>"==="true") {
            alert("현위치를 기반으로 긴급대피소를 탐색합니다.");
            location.href = "/locate?page=TemporaryMap";
        }
    </script>
</head>
        ...
        <div class="layout-page">
            ...
            >
                ...
                <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                    ...
                    <td class="py-3">
                        <h2 class="mb-1" style="text-align: center; color: #696cff">긴급대피소 찾기</h2>
                    </td>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <div class="card" style="padding-left: 50px;">
                                <br>
                                <h5 id="h5" class="card-title text-primary">원하시는 긴급대피소를 우측에서 선택해주세요.
                                </h5>
                        ...
                        <div class="col-md-6 col-lg-4 order-2 mb-4">
                            <div class="card h-100">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h5 class="card-title m-0 me-2">긴급대피소 목록</h5>
                                    <div class="dropdown">
                                        <button
                                                class="btn p-0"
                                                type="button"
